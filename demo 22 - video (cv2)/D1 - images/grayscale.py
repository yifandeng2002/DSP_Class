...
# print(np.shape(img))			# equivalent to img.shape (need to import numpy as np)
...
cv2.waitKey(0)              # 0 means wait forever for a keystroke.
							# When a key is pressed, the program proceeds
